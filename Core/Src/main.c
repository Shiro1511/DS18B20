...
/* USER CODE BEGIN PV */
DS18B20_HandleTypeDef hds18b20_1;
...
int main(void)
{
  ...
  while (1)
  {
    ...
    {
      if (DS18B20_StartConversion(&hds18b20_1) == DS18B20_OK)
      {
        if (DS18B20_ReadTemperature(&hds18b20_1, &temperature) == DS18B20_OK)
        {
          LCD_Clear_Display(&hlcd);
          LCD_SetCursor(&hlcd, 0, 0);
          LCD_Print(&hlcd, "Temp: ");
